...
bool VkEmulation::supportsExternalMemoryMetal() const {
    return mInstanceSupportsExternalMemoryMetal;
}

bool VkEmulation::supportsPortabilityEnumeration() const {
    return mInstanceSupportsPortabilityEnumeration;
}
